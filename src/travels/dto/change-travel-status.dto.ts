...
export class UpdateTravelStatusDto {
  @IsIn(Object.values(TravelStatusEnum).filter((e) => e !== TravelStatusEnum.PENDING && e !== TravelStatusEnum.FULLY_BOOKED && e !== TravelStatusEnum.BOOKING))
  status: TravelStatusEnum.ACCIDENT |
